...
public class WeeklyGraphFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_weekly_graph, container, false);
        graph = rootView.findViewById(R.id.graph); // Make sure your layout has a GraphView with this ID
    ...
    private void fetchGraphData() {
        ...
        Call<GraphDataResponseModel> call = apiService.getWeeklyGraphData(); // Use your API endpoint here
...
//                Toast.makeText(getContext(), "Network Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void displayGraphData(List<GraphDataResponseModel.GraphData> graphDataList) {
        ...
        series.setColor(Color.BLUE); // Change to desired color
        ...
        graph.getViewport().setMaxX(7); // Adjust this according to your data (for a week)
